...
function Quanti({onClickBack, onClickNext, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-3rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: IT324 - Quantitative Methods</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                        ...
                        <CheckBox value="F 7:30AM-9:30PM" title="F 7:30AM-9:30PM"></CheckBox>
