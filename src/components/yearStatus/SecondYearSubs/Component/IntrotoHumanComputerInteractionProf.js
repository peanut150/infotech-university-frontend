...
function IntrotoHumanComputerInteraction({onClickBack, onClickNext, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-3rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: IT211 - Intro to Human Computer Interaction</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                >
                    <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 1: Mr. Feliciano T. Legara IV</h1>
                </div>
                
                <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                    <CheckBox value="M 8:00AM-11:00AM" title="M 8:00AM-11:00AM"></CheckBox>
                    <CheckBox value="TH 7:30AM-10:30AM" title="TH 7:30AM-10:30AM"></CheckBox>
                    <CheckBox value="F 1:00PM-4:00PM" title="F 1:00PM-4:00PM"></CheckBox>
                </div>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    >
                        <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 2: Ms. Tan Chris</h1>
                    </div>
                    
                    <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                        <CheckBox value="T 1:00PM- 4:00PM" title="T 1:00PM- 4:00PM"></CheckBox>
                        <CheckBox value="W 1:30PM-4:30PM" title="W 1:30PM-4:30PM"></CheckBox>
...
export default IntrotoHumanComputerInteraction;