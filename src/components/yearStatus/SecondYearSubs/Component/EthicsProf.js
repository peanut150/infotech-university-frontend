...
function Ethics({onClickBack, onClickNext, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-3rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: Ethc - Ethics</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                >
                    <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 1: Mr. Leo U. Bete</h1>
                </div>
                ...
                <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                    ...
                    <CheckBox value="TH 4:30PM-6:00PM" title="TH 4:30PM-6:00PM"></CheckBox>
                </div>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    >
                        <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 2: Ms. Kriz Dy</h1>
                    </div>
